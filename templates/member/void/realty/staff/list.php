...
$dt->addLabelColumn($this->localize->_('mobile'), '@{mobile}', 'small', 'left');
$dt->addLabelColumn($this->localize->_('phone'), '@{phone}', 'small', 'left');
$dt->addLabelColumn($this->localize->_('realty_staff_position'), '@{position}', 'small', 'left');
