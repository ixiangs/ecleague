...
$f->newField($this->localize->_('status'), true,
    $this->html->select('status', 'data[status]', $this->model->getStatus(), array(
        \Void\Auth\Constant::STATUS_ACCOUNT_ACTIVATED => $this->localize->_('auth_status_activated'),
        \Void\Auth\Constant::STATUS_ACCOUNT_NONACTIVATED => $this->localize->_('auth_status_nonactivated'),
        \Void\Auth\Constant::STATUS_ACCOUNT_DISABLED => $this->localize->_('disabled')
    )));
