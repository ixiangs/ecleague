                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-big leftonmobile">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <p><span class="label label-info"><i class="fa fa-cloud"></i></span> Syncing Photos to
                                    Server</p>
                                <hr>
                                <p><span class="label label-warning"><i class="fa fa-cloud"></i></span> Syncing
                                    Bookmarks Lists to Cloud</p>
                    ...
                    <li class="dropdown dropdown-big leftonmobile">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <h6><a href="#">How are you?</a> <span
                                        class="label label-warning pull-right">20:42</span></h6>

                                <div class="clearfix"></div>
                                <hr>
                            </li>
                            <li>
                                <h6><a href="#">What are you doing?</a> <span class="label label-warning pull-right">14:42</span>
                                </h6>
                    ...
                    <li class="dropdown dropdown-big">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <hr>
                                <!-- List item heading h6-->
                                <h6><a href="#">John Doe</a> <span class="label label-warning pull-right">Free</span>
                                </h6>
                            ...
                            <li>
                                <h6><a href="#">Iron Man</a> <span
                                        class="label label-important pull-right">Premium</span></h6>

                                <div class="clearfix"></div>
                                <hr>
                            </li>
                            <li>
                                <h6><a href="#">Salamander</a> <span class="label label-warning pull-right">Free</span>
                                </h6>
