...
$dt->addLabelColumn($this->localize->_('auth_domain'), '@{domains}', 'small', 'small text-center')
...
$dt->addStatusColumn($this->localize->_('status'), '@{status}', array(
        \Void\Auth\Constant::STATUS_ACCOUNT_ACTIVATED=>'<span class="label label-success">'.$this->localize->_('auth_status_activated').'</span>',
        \Void\Auth\Constant::STATUS_ACCOUNT_NONACTIVATED=>'<span class="label label-warning">'.$this->localize->_('auth_status_nonactivated').'</span>',
        \Void\Auth\Constant::STATUS_ACCOUNT_DISABLED=>'<span class="label label-danger">'.$this->localize->_('disabled').'</span>'),
