...
include_once TOYS_PATH . 'Data' . DS . 'Helper.php';
...
include_once TOYS_PATH . 'Orm' . DS . 'BaseProperty.php';
include_once TOYS_PATH . 'Orm' . DS . 'IntegerProperty.php';
include_once TOYS_PATH . 'Orm' . DS . 'ArrayProperty.php';
include_once TOYS_PATH . 'Orm' . DS . 'StringProperty.php';
include_once TOYS_PATH . 'Orm' . DS . 'BooleanProperty.php';
include_once TOYS_PATH . 'Orm' . DS . 'EmailProperty.php';
include_once TOYS_PATH . 'Orm' . DS . 'DateTimeProperty.php';
include_once TOYS_PATH . 'Orm' . DS . 'FloatProperty.php';
include_once TOYS_PATH . 'Orm' . DS . 'SerializeProperty.php';
include_once TOYS_PATH . 'Orm' . DS . 'Query.php';
include_once TOYS_PATH . 'Orm' . DS . 'Entity.php';
include_once TOYS_PATH . 'Orm' . DS . 'Model.php';
include_once TOYS_PATH . 'Orm' . DS . 'Result.php';
...
\Toys\Unit\Runner::run(array(
        'directory' => TOYS_PATH . 'Orm' . DS . 'test',
        'output' => 'console')
);
