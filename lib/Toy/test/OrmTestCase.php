	...
	protected function getMetadata(){
		return array(
			...
			'properties'=>array(
				...
				\Toy\Orm\StringProperty::create('fullname')->setRangeLength(6, 12),
				\Toy\Orm\IntegerProperty::create('age')->setRangeValue(1, 100)->setUpdateable(false),
				\Toy\Orm\StringProperty::create('mobile')->setNullable(false)->setRangeLength(11, 11)->setRegexp('/^1\d{10}$/')
			)
		);
	}
}
...
class OrmTestCase extends TestCase {
	...
	public function testEntity(){
		...
		$this->assertEqual('Toy\Orm\IntegerProperty', get_class($prop));
		...
		$this->assertEqual('Toy\Orm\StringProperty', get_class($prop));
