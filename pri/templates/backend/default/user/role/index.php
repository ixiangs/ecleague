...
<nav class="navbar navbar-default" role="navigation">
	<div class="navbar-header">
		<ol class="breadcrumb">
		  ...
		  <li class="active"><?php echo $this->languages['role_list']; ?></li>
		</ol>
  </div>
...
<th><?php echo $this->languages['behavior_list']; ?></th>
...
<?php
$codes = array();
foreach($this->behaviors as $bid=>$code):
	if(in_array($bid, $model->getBehaviorIds(array()))):
		$codes[] = $code;
	endif;
endforeach;
echo implode(', ', $codes);
